...
public:
    ...
    QPushButton *buttonBackToMenuAfterLose;
    QPushButton *buttonBackToMenuAfterLose_2;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        buttonBackToMenuAfterLose = new QPushButton(pageGame);
        buttonBackToMenuAfterLose->setObjectName("buttonBackToMenuAfterLose");
        buttonBackToMenuAfterLose->setGeometry(QRect(560, 270, 131, 51));
        QFont font4;
        font4.setFamilies({QString::fromUtf8("Comic Sans MS")});
        font4.setPointSize(8);
        font4.setBold(true);
        buttonBackToMenuAfterLose->setFont(font4);
        buttonBackToMenuAfterLose_2 = new QPushButton(pageGame);
        buttonBackToMenuAfterLose_2->setObjectName("buttonBackToMenuAfterLose_2");
        buttonBackToMenuAfterLose_2->setGeometry(QRect(720, 270, 131, 51));
        buttonBackToMenuAfterLose_2->setFont(font4);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        buttonBackToMenuAfterLose->setText(QCoreApplication::translate("MainWindow", "BACK TO MENU", nullptr));
        buttonBackToMenuAfterLose_2->setText(QCoreApplication::translate("MainWindow", "NEW GAME", nullptr));
